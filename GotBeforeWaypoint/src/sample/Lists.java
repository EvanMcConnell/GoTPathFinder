...
import java.util.List;
    ...
    public class Lists {
        ...
        public List populateNodeList(List<mapNode> nodeList){
            nodeList = new ArrayList<>();

            mapNode node1 = new mapNode("node 1", 265, 24);
            mapNode node2 = new mapNode("node 2", 472, 49);
            mapNode node3 = new mapNode("node 3", 390, 94);
            mapNode node4 = new mapNode("node 4", 514, 90);
            mapNode node5 = new mapNode("node 5", 250, 104);
            mapNode node6 = new mapNode("node 6", 536, 144);
            mapNode node7 = new mapNode("node 7", 127, 170);
            mapNode node8 = new mapNode("node 8", 250, 192);
            mapNode node9 = new mapNode("node 9", 472, 215);
            mapNode node10 = new mapNode("node 10", 347, 223);
            mapNode node11 = new mapNode("node 11", 140, 251);
            ...
            node19.addTwoWayNeighbor(node13, 0);
            node19.addTwoWayNeighbor(node18, 0);
            node19.addTwoWayNeighbor(node20, 0);
            node19.addTwoWayNeighbor(node23, 0);
            ...
            node36.addTwoWayNeighbor(node38, 0);
            node39.addTwoWayNeighbor(node40, 0);
            node39.addTwoWayNeighbor(node38, 0);
        ...
        public Graph populateGraph(Graph graph, List<mapNode> nodeList){ graph = new Graph(nodeList);  return graph; }

        public DijkstraGraph populateDJGraph(Graph graph, DijkstraGraph djGraph){ djGraph = new DijkstraGraph(graph); return djGraph; }
    }
